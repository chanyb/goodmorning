    ...
    public class GetFile {
        ...
        public boolean TextDownload(String Url, String FileName, String sSaveFile) {
            ...
            try {
                ...
                ex.printStackTrace();
                isComplete = false;
                globalViewModel.updateNotNeed.postValue(true);
            }
            return isComplete;
        }
        ...
        public boolean ContentDownload(String Url, String FileName, String sSaveFile) {
            ...
            try {
                ...
                while ((length = is.read(buffer)) >= 0) {
                    ...
                    mHandler.post(() -> globalViewModel._downloadPercent.postValue((int) progress));
                ...
                try {
                    ...
                    if (ServerUpdateFile != null) {
                        ...
                        if (updateNeeded.equals("Y")) {
                            ...
                            globalViewModel.updateString.postValue(message);
                            globalViewModel.updateNeeded.postValue(true);
                        } else {
                            globalViewModel.updateNotNeed.postValue(true);
